...
- If you use SSH for git remotes, the 1Password SSH agent (step 1) handles it; otherwise add a key with `ssh-keygen -t ed25519 -C "you@example"` and `gh ssh-key add ~/.ssh/id_ed25519.pub`.

## 6. macOS system prefs (optional)
